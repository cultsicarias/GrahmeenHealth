...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white overflow-hidden">
      <header className={`fixed w-full top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-md py-3' : 'bg-transparent py-6'}`}>
          ...
          <nav>
            <ul className="flex space-x-6">
              ...
              <li>
                <Link 
                  href="/register" 
                  className="bg-gradient-to-r from-blue-600 to-teal-500 text-white px-5 py-2 rounded-full hover:shadow-lg transition transform hover:-translate-y-0.5"
                >
                  Sign Up
                </Link>
              </li>
